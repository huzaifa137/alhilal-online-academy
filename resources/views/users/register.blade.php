...
@section('content')
    ...
    <div style="text-align: center; padding: 40px 20px 30px; background: linear-gradient(135deg, #6B46C1 0%, #DC2626 100%); border-radius: 0 0 30px 30px;">
        <img src="{{ asset('assets/images/al-hilaal_update.png') }}" alt="Logo" style="max-width: 100px; border-radius: 20px; margin-bottom: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
