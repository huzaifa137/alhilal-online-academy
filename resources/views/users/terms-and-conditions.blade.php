...
<section class="terms-hero">
    <div class="terms-hero-content">
        ...
        <p>Welcome to AlHilal Online Academy. By accessing our platform, you agree to these terms and conditions. Please read them carefully before using our services.</p>
        ...
        <div class="terms-grid">
            ...
            <div class="terms-content">
                ...
                <section id="introduction" class="terms-section">
                    ...
                    <h2>Welcome to AlHilal Online Academy</h2>
                    <p>AlHilal Online Academy is a premier online Islamic educational platform dedicated to providing quality Islamic education to students from Primary 1 through Senior 6. Our mission is to make authentic Islamic learning accessible, engaging, and effective for every Muslim student.</p>
                ...
                <section id="using-services" class="terms-section">
                    ...
                    <p>AlHilal Online Academy provides a comprehensive learning management system (LMS) that includes:</p>
                    <ul>
                ...
                <section id="copyright" class="terms-section">
                    ...
                    <p>is the exclusive property of AlHilal Online Academy or its content contributors and is protected by international copyright laws and Islamic ethical guidelines regarding knowledge sharing.</p>
                    <div class="highlight-box">
                        <p><strong>⚠️ Prohibited Actions:</strong> You may not reproduce, distribute, modify, create derivative works from, publicly display, or sell any content from our platform without explicit written permission from AlHilal Online Academy.</p>
                    </div>
                ...
                <section id="account" class="terms-section">
                    ...
                    <p>As a registered user of AlHilal Online Academy, you agree to:</p>
                    <ul>
                ...
                <section id="payments" class="terms-section">
                    ...
                    <p>AlHilal Online Academy offers both free and paid learning options:</p>
                    <ul>
                    ...
                    <div class="highlight-box">
                        <p><strong>💡 Need-Based Scholarships:</strong> AlHilal Academy offers limited need-based scholarships for deserving students. Contact our admissions team for more information.</p>
                    </div>
                </section>
