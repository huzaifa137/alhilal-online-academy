...
<div style="display: flex; flex-direction: column; min-height: 100vh;">
    ...
    <div class="fp-wrapper">
        ...
        <div class="fp-left">
            ...
            <div class="fp-left-content">
                ...
                <p>Reset your password securely in three simple steps. Your AlHilal Academy account and learning progress will remain safe.</p>
        ...
        <div class="fp-right">
            ...
            <div class="fp-right-top">
                <a href="{{ url('/') }}" class="fp-right-logo">
                    ...
                    <div>
                        <div class="fp-right-logo-text">AlHilal Academy</div>
    ...
    <div class="fp-page-footer">
        &copy; {{ date('Y') }} AlHilal Online Academy &nbsp;·&nbsp;
        <a href="{{ url('/') }}">Home</a> &nbsp;·&nbsp;
