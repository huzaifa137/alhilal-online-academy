                ...
                <div class="welcome-banner">
                    ...
                    <div class="welcome-text">
                        ...
                        <div class="welcome-sub">
                            You have <strong style="color:#C084FC;">3 classes today</strong> and <strong
                                style="color:#F87171;">5
                                pending submissions</strong> awaiting your review.
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="quick-actions-grid">
                            ...
                            <a href="#" class="qa-btn">
                                <div class="qa-icon" style="background:#EDE9FA;color:#7C3AED;"><i
                                        class="fas fa-chart-bar"></i>
                                </div>
                                <div class="qa-label">View Reports</div>
                            </a>
                            <a href="#" class="qa-btn">
                                <div class="qa-icon" style="background:#DBEAFE;color:#2563EB;"><i class="fas fa-video"></i>
                                </div>
                                <div class="qa-label">Start Session</div>
                            </a>
                            <a href="#" class="qa-btn">
                                <div class="qa-icon" style="background:#FCE7F3;color:#DB2777;"><i
                                        class="fas fa-bullhorn"></i></div>
                                <div class="qa-label">Announcement</div>
                            </a>
                            <a href="#" class="qa-btn">
                                <div class="qa-icon" style="background:#D1FAE5;color:#059669;"><i
                        ...
                        <div class="class-list">
                            ...
                            <div class="class-item">
                                <div class="class-color-bar"
                                    style="background:linear-gradient(135deg,var(--red),var(--gold));">
                                </div>
                                <div class="class-info">
                            ...
                            <div class="class-item">
                                <div class="class-color-bar"
                                    style="background:linear-gradient(135deg,var(--green),#0EA5E9);"></div>
                                <div class="class-info">
                            ...
                            <div class="class-item">
                                <div class="class-color-bar" style="background:linear-gradient(135deg,#7C3AED,#0EA5E9);">
                                </div>
                                <div class="class-info">
                            ...
                            <div class="class-item">
                                <div class="class-color-bar"
                                    style="background:linear-gradient(135deg,var(--gold),var(--red));">
                                </div>
                                <div class="class-info">
                            ...
                            <div class="class-item">
                                <div class="class-color-bar"
                                    style="background:linear-gradient(135deg,#DB2777,var(--purple));">
                                </div>
                                <div class="class-info">
                            ...
                            <table class="student-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="status-badge status-active"><i class="fas fa-circle"
                                                    style="font-size:5px;"></i> Active</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress-mini-wrap">
                                                <div class="progress-mini-bar">
                                                    <div class="progress-mini-fill" style="width:74%;"></div>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress-mini-wrap">
                                                <div class="progress-mini-bar">
                                                    <div class="progress-mini-fill" style="width:61%;"></div>
                                                </div>
                                                <div class="progress-mini-pct">61%</div>
                                            </div>
                                        </td>
                                        <td><span class="status-badge status-pending"><i class="fas fa-circle"
                                                    style="font-size:5px;"></i> Pending</span></td>
                                        <td><a href="#" class="assignment-btn">View</a></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress-mini-wrap">
                                                <div class="progress-mini-bar">
                                                    <div class="progress-mini-fill" style="width:42%;"></div>
                                                </div>
                                                <div class="progress-mini-pct">42%</div>
                                            </div>
                                        </td>
                                        <td><span class="status-badge status-inactive"><i class="fas fa-circle"
                                                    style="font-size:5px;"></i> Inactive</span></td>
                                        <td><a href="#" class="assignment-btn">View</a></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="activity-list">
                                <div class="activity-item">
                                    ...
                                    <div class="activity-text">
                                        <div class="activity-msg"><strong>Yusuf Mugenyi</strong> completed Tajweed Quiz —
                                            scored 94%
                                        </div>
                                ...
                                <div class="activity-item">
                                    ...
                                    <div class="activity-text">
                                        <div class="activity-msg"><strong>Aisha Kamara</strong> submitted assignment: Seerah
                                            Essay
                                        </div>
                                ...
                                <div class="activity-item">
                                    ...
                                    <div class="activity-text">
                                        <div class="activity-msg"><strong>Fatuma Atieno</strong> has not logged in for 7
                                            days</div>
                                ...
                                <div class="activity-item">
                                    ...
                                    <div class="activity-text">
                                        <div class="activity-msg"><strong>New student</strong> Omar Kiggundu joined Arabic
                                            Beginners
                                        </div>
                                ...
                                <div class="activity-item">
                                    ...
                                    <div class="activity-text">
                                        <div class="activity-msg"><strong>Mariam Nakato</strong> asked a question in Fiqh
                                            forum
                                        </div>
                                ...
                                <div class="activity-item">
                                    ...
                                    <div class="activity-text">
                                        <div class="activity-msg"><strong>Ibrahim Ssekatawa</strong> earned a Memorization
                                            Badge 🏅
                                        </div>
                            ...
                            <div class="assignment-list">
                                ...
                                <div class="assignment-item">
                                    ...
                                    <div class="assignment-info">
                                        ...
                                        <div class="assignment-meta">
                                            <span><i class="fas fa-chalkboard" style="margin-right:4px;"></i>Tajweed
                                                Adv.</span>
                                ...
                                <div class="assignment-item">
                                    ...
                                    <div class="assignment-info">
                                        ...
                                        <div class="assignment-meta">
                                            <span><i class="fas fa-chalkboard" style="margin-right:4px;"></i>Fiqh Grade
                                                5</span>
                                ...
                                <div class="assignment-item">
                                    ...
                                    <div class="assignment-info">
                                        ...
                                        <div class="assignment-meta">
                                            <span><i class="fas fa-chalkboard" style="margin-right:4px;"></i>Quran Level
                                                2</span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:4px;">
                                <div
                                    style="background:var(--green-light);border-radius:14px;padding:14px;text-align:center;">
                                    <div
                                        style="font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:700;color:var(--green);">
                                        91%</div>
                                ...
                                <div style="background:var(--red-light);border-radius:14px;padding:14px;text-align:center;">
                                    <div
                                        style="font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:700;color:var(--red);">
                                        9%</div>
                                    <div style="font-size:0.75rem;color:var(--red);font-weight:600;margin-top:2px;">Absent
                                        Rate
                                    </div>
                                </div>
                            </div>
        ...
        <div class="sd-modal-box">
            ...
            <form id="addLessonForm" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lessonNumber" placeholder="e.g., Lesson 1, Chapter 2"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="contentUrl"
                        placeholder="YouTube URL, audio link, or PDF link">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="lessonDesc" rows="3"
                        placeholder="Brief description of the lesson..."></textarea>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label><strong>Duration (minutes)</strong></label>
                        <input type="number" class="form-control" id="lessonDuration" placeholder="e.g., 15" value="15"
                            min="1" max="60">
                    </div>
                    <div class="form-group">
